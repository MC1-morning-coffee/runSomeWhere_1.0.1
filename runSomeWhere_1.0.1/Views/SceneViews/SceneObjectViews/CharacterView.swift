...
struct CharacterView: View {
    ...
    func updateImage(direction: CharcterDirection, Name: String) {
        switch direction {
        case .Left:
...
struct CharacterView_Previews: PreviewProvider {
    static var previews: some View {
        CharacterView(objectName: henry.name, makeDirection: CharcterDirection.Back_1, start: (0, 0), end: (100, 100))
    }
}
